                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li <?php if ($hal == 'home'){echo "class='active open'";}  ?>>
                            <a href="<?php echo base_url('logincms/home') ?>"><i class="icon-home"></i><span>Beranda </span></a>
                        </li>
                        ...
                        <li <?php if ($hal == 'slider' OR $hal == 'gallery'){echo "class='active open'";}  ?>> <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block"><i class="icon-picture"></i><span>Foto</span></a>
                            <ul class="ml-menu">
                                <li ><a href="<?php echo base_url('logincms/gallery'); ?>" class=" waves-effect waves-block">Galeri</a></li>
                                <li ><a href="<?php echo base_url('logincms/slider'); ?>">Slider</a></li>
                            </ul>
                        </li>

                        <li <?php if ($hal2 == 'contact_us'){echo "class='active open'";}  ?> class="dropdown notifications">
                            <a href="<?php echo base_url('logincms/static_page/contact_us'); ?>" class="menu-toggle"><i class="icon-envelope"></i><span>Pesan</span></a>
                        </li>
