                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php if($kat['category_photo']==null){ echo base_url('gambar/category/no-image.jpg'); } else {echo base_url('gambar/category/').$kat['category_photo']; } ?>" height="50" width="70"></td>
