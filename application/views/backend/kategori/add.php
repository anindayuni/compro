                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form class="form-horizontal" id="form_validation" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="category_date" value="<?php date('Y-m-d'); ?>">
                            <div class="row clearfix">
                           ...
                           <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-8 offset-sm-2">
                                    <button type="submit" class="btn btn-raised btn-primary btn-round waves-effect"  name="submit">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
