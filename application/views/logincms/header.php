...
<div class="page-loader-wrapper">   
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="assets/logincms/images/logo.svg" width="48" height="48" alt="sQuare"></div>
        <p>Please wait...</p>        
    </div>
</div>
        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="navbar-logo">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="assets/logincms/images/logo.svg" width="30" alt="infinity"><span class="m-l-10">infinity</span></a>
                </div>
                            ...
                            <li class="body">
                                <ul class="menu list-unstyled">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <div class="media">
                                                <img class="media-object" src="assets/logincms/images/xs/avatar6.jpg" alt="">
                                                <div class="media-body">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <div class="media">
                                                <img class="media-object" src="assets/logincms/images/xs/avatar3.jpg" alt="">
                                                <div class="media-body">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <div class="media">
                                                <img class="media-object" src="assets/logincms/images/xs/avatar4.jpg" alt="">
                                                <div class="media-body">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <div class="media">
                                                <img class="media-object" src="assets/logincms/images/xs/avatar8.jpg" alt="">
                                                <div class="media-body">
