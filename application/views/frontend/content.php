    ...
    <?php foreach ($article as $key => $artikel): ?>
        <article class="single-blog-post">
            ...
            <div class="post-thumb">
                <a href="#" class="popular-img"><img src="<?php if (!empty($artikel['photo_img'])) echo base_url().'gambar/article/'.$artikel['photo_img']; else echo base_url('gambar/no-image.png'); ?>" style="max-height: 435px;" alt="<?= $artikel['article_title']; ?>">
