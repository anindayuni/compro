            ...
            <div class="media">
                <div class="media-left">
                    <div class="post-thumb">
                        ...
                        <a href="#" class="popular-img"><img src="<?php if (!empty($article['photo_img'])) echo base_url().'gambar/article/'.$article['photo_img']; else echo base_url('gambar/no-image.png'); ?>" style="max-width: 362px; max-height: 270px; " alt="<?= $article['article_title']; ?>">
